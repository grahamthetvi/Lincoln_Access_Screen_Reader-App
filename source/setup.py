...
_py2ExeWindows = [
	{
		...
		"icon_resources": [(1, "images/lincolnAccessScreenReader.ico")],
		"other_resources": [_genManifestTemplate(shouldHaveUIAccess=False)],
		"version_info": {
			"version": formatBuildVersionString(),
			"description": "Lincoln Access Screen Reader application (no UIAccess)",
			"product_name": name,
...
if _partialArgs.uiAccess:
	_py2ExeWindows.insert(
		1,
		{
			...
			"version_info": {
				"version": formatBuildVersionString(),
				"description": "Lincoln Access Screen Reader application (has UIAccess)",
				"product_name": name,
				"product_version": version,
				"copyright": NVDAcopyright,
				"company_name": publisher,
