...
class WelcomeDialog(
	...
	"""The welcome dialog for Lincoln Access Screen Reader.
	This provides essential information for new users,
	such as a description of the screen reader modifier key and instructions on how to activate the menu.
	...
	WELCOME_MESSAGE_DETAIL = _(
		# Translators: The main message for the Welcome dialog when the user starts the screen reader for the first time.
		"Most commands for controlling Lincoln Access Screen Reader require you to hold down"
		" the screen reader key while pressing other keys.\n"
		"By default, the Insert and numpad Insert keys may both be used as the screen reader key.\n"
		"You can also configure Lincoln Access Screen Reader to use the CapsLock as the screen reader key.\n"
		"Press the screen reader key+n at any time to activate the menu.\n"
		"From this menu, you can configure the screen reader, get help, and access other functions.",
	)
	_instances: Set["WelcomeDialog"] = weakref.WeakSet()

	def __init__(self, parent):
		# Translators: The title of the Welcome dialog when user starts the screen reader for the first time.
		super().__init__(parent, wx.ID_ANY, _("Welcome to Lincoln Access Screen Reader"))
		WelcomeDialog._instances.add(self)

		mainSizer = wx.BoxSizer(wx.VERTICAL)
		# Translators: The header for the Welcome dialog when user starts the screen reader for the first time.
		# This is in larger, bold lettering
		welcomeTextHeader = wx.StaticText(self, label=_("Welcome to Lincoln Access Screen Reader!"))
		...
		capsAsNVDAModifierText = _("&Use CapsLock as a screen reader modifier key")
		...
		# Translators: The label of a checkbox in the Welcome dialog.
		startAfterLogonText = _("St&art Lincoln Access Screen Reader after I sign in")
		...
		# Translators: The label of a checkbox in the Welcome dialog.
		showWelcomeDialogAtStartupText = _("&Show this dialog when Lincoln Access Screen Reader starts")
		...
		if NVDAKeysVal == 0:
			...
			gui.messageBox(
				_(
					...
					"At least one screen reader modifier key must be set. "
					"Caps lock will remain as a screen reader modifier key. ",
				),
				# Translators: The title of an error message box displayed when validating the startup dialog
				_("Error"),
				wx.OK | wx.ICON_ERROR,
...
class LauncherDialog(
	...
	"""The dialog that is displayed when Lincoln Access Screen Reader is started from the launcher.
	This displays the license and allows the user to install or create a portable copy.
	"""
	...
	def __init__(self, parent: wx.Window | None):
		...
		self.actionButtons = []
		# Translators: The label of the button in the launcher to install on the user's computer.
		ctrl = wx.Button(self, label=_("&Install Lincoln Access Screen Reader on this computer"))
		sizer.Add(ctrl)
