...
ICON_PATH = os.path.join(NVDA_PATH, "images", "lincolnAccessScreenReader.ico")
...
class MainFrame(wx.Frame):
	...
	def onAboutCommand(self, evt: wx.CommandEvent):
		...
		aboutDialog = MessageDialog(None, versionInfo.aboutMessage, _("About Lincoln Access Screen Reader"))
	...
	def onRunCOMRegistrationFixesCommand(self, evt: wx.CommandEvent) -> None:
		...
		progressDialog = IndeterminateProgressDialog(
			...
			_("Please wait while Lincoln Access Screen Reader attempts to fix your system's COM registrations..."),
		)
		error: str | None = None
		try:
...
class SysTrayIcon(wx.adv.TaskBarIcon):
	def __init__(self, frame: MainFrame):
		...
		item = menu_preferences.Append(
			wx.ID_ANY,
			# Translators: The label for the menu item to open Settings dialog.
			_("&Settings..."),
			# Translators: The description for the menu item to open Settings dialog.
			_("Lincoln Access Screen Reader settings"),
		)
		...
		# Translators: The label for Preferences submenu in the screen reader menu.
		...
		if not globalVars.appArgs.secure and not config.isAppX and not NVDAState.isRunningAsSource():
			# Translators: The label for the menu item to create a portable copy from an installed or another portable version.
			...
			if not config.isInstalledCopy():
				# Translators: The label for the menu item to install on the computer.
				item = menu_tools.Append(wx.ID_ANY, _("&Install Lincoln Access Screen Reader..."))
		...
		# Translators: The label for the Tools submenu in the screen reader menu.
		...
		item = self.menu.Append(
			wx.ID_EXIT,
			# Translators: The label for the menu item to exit
			_("E&xit"),
			# Translators: The help string for the menu item to exit
			_("Exit Lincoln Access Screen Reader"),
		)
	...
	def _appendHelpSubMenu(self, frame: MainFrame) -> None:
		...
		if not globalVars.appArgs.secure:
			# Translators: The label of a menu item to open the user guide.
			...
			# Translators: The label for the menu item to open the Welcome dialog.
		...
		# Translators: The label for the Help submenu in the screen reader menu.
