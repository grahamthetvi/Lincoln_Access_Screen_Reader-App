...
[update]
	...
	startupNotification = boolean(default=false)
...
[addonStore]
	# When false, NV Access add-on catalog metadata is not fetched (no outbound store traffic).
	enableRemoteCatalog = boolean(default=false)
	automaticUpdates = option("notify", "update", "disabled", default="disabled")
