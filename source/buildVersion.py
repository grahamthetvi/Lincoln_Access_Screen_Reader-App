...
"""
This module contains non-localizable version information for Lincoln Access Screen Reader such as the version string and major and minor numbers etc.
...
# Version information for Lincoln Access Screen Reader (GPLv2; derived from the NVDA project)
name = "Lincoln Access Screen Reader"
version_year = 2026
version_major = 2
version_minor = 0
version_build = 0  # Should not be set manually. Set in 'sconscript'.
version = _formatDevVersionString()
publisher = "Addison Graham"
copyrightYears = "2006-2026"
url = "https://github.com/grahamthetvi/Lincoln_Access_Screen_Reader"
